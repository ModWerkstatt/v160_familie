...
return {
	info = {
        ...
        params = {
			...
			{
				key = "v160_familie_br226",
				name = _("v160_familie_br226"),
				values = { "No", "Yes", },
	...
	runFn = function (settings, modParams)
		...
		local br226Filter = function(fileName, data)
			if data.metadata.transportVehicle and data.metadata.v160_familie and data.metadata.v160_familie.br226 == true then
				data.metadata.availability.yearFrom = 1
				data.metadata.availability.yearTo = 2
			end
			return data
